...
get_ipython().run_line_magic('time', 'hist1 = train_model(env, model, total_episodes=10)')
...
# %time hist4 = train_model(env, model, total_episodes=500)
...
get_ipython().run_line_magic('time', 'hist4 = train_model(env, model, total_episodes=100)')
