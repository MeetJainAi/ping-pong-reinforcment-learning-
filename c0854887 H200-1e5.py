...
get_ipython().run_line_magic('time', 'hist2 = train_model(env, model, total_episodes=50)')
...
get_ipython().run_line_magic('time', 'hist4 = train_model(env, model, total_episodes=1000)')
